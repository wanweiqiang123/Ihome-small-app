...
* @version:
* @Author: lsj
* @Date: 2021-03-25 15:49:33
* @LastEditors: lsj
* @LastEditTime: 2021-03-25 17:23:57
-->
<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
      ...
      <view class="un-time" @click="handleUnTime('confirm')">无固定期限</view>
		</view>
	</u-popup>
</template>
...
export default {
	...
	props: {
		...
		// 模式选择，time-时间类型，selector-单列模式，multiSelector-多列模式
		mode: {
			type: String,
			default: 'time'
		},
    ...
    handleUnTime(event) {
      ...
      if (this.params.year) result.year = '9999';
      if (this.params.month) result.month = '99';
      if (this.params.day) result.day = '99';
      if (this.params.hour) result.hour = '99';
      if (this.params.minute) result.minute = '99';
      if (this.params.second) result.second = '99';
